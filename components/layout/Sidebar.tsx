...
export default function Sidebar({ profile }: { profile: Profile | null }) {
  ...
  return (
    <aside className="hidden md:flex w-64 flex-col shrink-0 relative"
      ...
      {/* Logo */}
      <div className="px-5 h-16 flex items-center gap-3 relative" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div>
          <span className="font-black text-sm tracking-wider text-white" style={{ fontFamily: 'system-ui', letterSpacing: '0.08em' }}>
      ...
      {/* Nav label */}
      <p className="px-5 pt-3 pb-1 text-xs font-bold tracking-widest" style={{ color: 'rgba(255,255,255,0.2)', fontSize: '10px', letterSpacing: '0.2em' }}>
        NAVIGAZIONE
      </p>
